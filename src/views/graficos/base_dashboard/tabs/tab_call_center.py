...
def render(tab6_data, charts_resultados):
    ...
    # Este DataFrame ya contiene SOLO los créditos de los Call Centers
    ...
    with col2:
        ...
        # El gráfico de torta ahora refleja solo los rodamientos de los créditos de Call Centers
    ...
    if not df_raw.empty:
        st.subheader("Resumen de Metas por Call Center")
    ...
    # --- SECCIÓN DE DETALLE DE CRÉDITOS ---
